    ...
    public class AuthenticacionQuery : IAuthenticationQuery
    {
        ...
        public async Task<ClienteCarritoDTOs> getCarrito(string uids)
        {
            ...
            if(FirebaseApp.DefaultInstance == null)
            {
                ...
                {
                    Credential = GoogleCredential.FromFile(@"C:\Users\ayala\Github\Pagina-web-Proyecto-final\Repositorio Microservicios\MicroservicioUser\Privatekey\usuario-5093e-firebase-adminsdk-43fcf-1bf89503c6.json"),
                });
            }
